...
void Digit::Morph2() {
  ...
  if (_morphcnt <= segWidth)
  {
   int i = _morphcnt;
   if (i < segWidth) {
     drawPixel(segWidth - i, segHeight * 2 + 2, _color); //A
    ...
    drawPixel(0, segHeight * 2 + 1 - i, _black);  // Erase F
    drawLine(1 + i, 1, 1 + i, segHeight, _black); //Erase C
    _morphcnt++;
  }
  else
    _oldvalue = _value;
...
void Digit::Morph3() {
  ...
  {
    int i = _morphcnt;
    drawLine(0 + i, 1, 0 + i, segHeight, _black); //Erase E
    drawPixel(0, segHeight * 2 + 1 - i, _black);  // Erase F

    drawLine(1 + i, 1, 1 + i, segHeight, _color); //C
  _morphcnt++;
  }
  else
    _oldvalue = _value;
...
void Digit::Morph6() {
  ...
  if (_morphcnt <= segWidth)
  {
    ...
    drawPixel(segWidth + 1, segHeight + 2 + i, _black);         // Erase B
    drawLine(segWidth - i, 1, segWidth - i, segHeight, _color); // Draw E
...
void Digit::Morph1() {
  ...
  if (_morphcnt <= (segWidth + 1))
  {
    int i = _morphcnt;
    // Move E left to right
    drawLine(0 + i - 1, 1, 0 + i - 1, segHeight, _black); //E
    drawLine(0 + i, 1, 0 + i, segHeight, _color);         // C
    // drawLine(0 + i-3, 1, 0 + i-3, segHeight, _color);         // C

    // Move F left to right
    drawLine(0 + i - 1, segHeight * 2 + 1, 0 + i - 1, segHeight + 2, _black); //F
    drawLine(0 + i, segHeight * 2 + 1, 0 + i, segHeight + 2, _color);         // B
    // drawLine(0 + i-3, segHeight * 2 + 1, 0 + i-3, segHeight + 2, _color);         // B
